...
namespace YiSha.Admin.Web.Areas.OrganizationManage.Controllers
{
    ...
    public class PunchReviewController : Controller
    {
        ...
        #region 视图功能
        [AuthorizeFilter("organization:punchreview:view")]
        public IActionResult PunchReviewIndex()
        {
            return View();
        }
        [AuthorizeFilter("organization:punchreview:add, organization:punchreview:edit")]
        public IActionResult PunchReviewForm()
        {
            return View();
        }
